GitBook plugin: Target logo
===========================

NPM package [here](https://www.npmjs.com/package/gitbook-plugin-target-logo)

```
npm i gitbook-plugin-target-logo
```
...
```json
{
    "plugins": ["target-logo", "another plugin 1", "another plugin 2"]
}
```
